    ...
    <div className="relative w-full h-full  md:h-screen overflow-hidden">
      <div
        className={cn(
          ...
          "dark:[background-image:linear-gradient(to_right,#262626_1px,transparent_1px),linear-gradient(to_bottom,#262626_1px,transparent_1px)] opacity-30"
        )}
      />
      <HeroSportLight />
          ...
          <div className="left-side md:w-[60%] lg:w-full">
            ...
            <div className="space-x-5 space-y-4 md:space-y-0 md:flex justify-center items-center mt-8">
              ...
              <div>
                ...
                <button className="relative inline-flex h-12 overflow-hidden rounded-full p-[1px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50 w-[92%] md:w-auto">
          ...
          <div className="right-side flex justify-center md:w-[40%] lg:w-full  ">
            ...
            >
              <Image
                ...
                width={500}
                height={500}
                className="w-[85%]  h-full justify-center rounded-md ring-3 ring-purple-500/70 dark:ring-sky-500/70"
              />
            </motion.div>
          </div>
        </div>
