...
function Aboutme() {
  return (
    <div
      id="About"
      className="overflow-hidden min-h-screen dark:bg-gradient-to-t dark:from-[#0e152d] dark:to-[#020617] grid-flow-dense grid grid-cols-1 lg:grid-cols-2 py-5 bg-gradient-to-tl from-purple-500/20 to-sky-500/20"
    >
